...
public class MockUpContent {
    ...
    private void initAllTheSongsInTheWorld(){
        ...
        allTheSongsInTheWorld = new Song[]{
                ...
                new Song("Gorillaz", "Plastic Beach", "Broken", R.drawable.plastic_beach_1000_1000, userRecommandations),
                new Song("Gorillaz", "Plastic Beach", "Cloud of unknowing", R.drawable.plastic_beach_1000_1000, userRecommandations),
                new Song("Gorillaz", "Plastic Beach", "White flag", R.drawable.plastic_beach_1000_1000, userRecommandations),
                new Song("Gorillaz", "Plastic Beach", "Empire Ants", R.drawable.plastic_beach_1000_1000, userRecommandations),
                new Song("Gorillaz", "Plastic Beach", "Stylo", R.drawable.plastic_beach_1000_1000, userRecommandations),
                new Song("Gorillaz", "Plastic Beach", "Orchestral intro", R.drawable.plastic_beach_1000_1000, userRecommandations),
                new Song("Gorillaz", "Plastic Beach", "Welcome To the World Of The Plastic Beach", R.drawable.plastic_beach_1000_1000, userRecommandations),
                new Song("Gorillaz", "Plastic Beach", "Rhinestones Eyes", R.drawable.plastic_beach_1000_1000, userRecommandations),
                new Song("Gorillaz", "Plastic Beach", "Stylo", R.drawable.plastic_beach_1000_1000, userRecommandations),
                new Song("Gorillaz", "Plastic Beach", "Superfast Jellyfish", R.drawable.plastic_beach_1000_1000, userRecommandations),
                new Song("Gorillaz", "Plastic Beach", "Glitter Freeze", R.drawable.plastic_beach_1000_1000, userRecommandations),
                new Song("Gorillaz", "Plastic Beach", "some Kind Of Nature", R.drawable.plastic_beach_1000_1000, userRecommandations),
                new Song("Gorillaz", "Plastic Beach", "On Melamcholy Hill", R.drawable.plastic_beach_1000_1000, userRecommandations),
                new Song("Gorillaz", "Plastic Beach", "Sweeptakes", R.drawable.plastic_beach_1000_1000, userRecommandations),
                new Song("Gorillaz", "Plastic Beach", "Plastic Beach", R.drawable.plastic_beach_1000_1000, userRecommandations),
                new Song("Gorillaz", "Plastic Beach", "To Binge", R.drawable.plastic_beach_1000_1000, userRecommandations),
                new Song("Gorillaz", "Plastic Beach", "Pirate Jet", R.drawable.plastic_beach_1000_1000, userRecommandations),

                new Song("Gorillaz", "Demon Days", "Intro", R.drawable.gorillaz_demondays, userRecommandations),
                new Song("Gorillaz", "Demon Days", "Last Living Souls", R.drawable.gorillaz_demondays, userRecommandations),
                new Song("Gorillaz", "Demon Days", "Kids With Guns", R.drawable.gorillaz_demondays, userRecommandations),
                new Song("Gorillaz", "Demon Days", "O Green World", R.drawable.gorillaz_demondays, userRecommandations),
                new Song("Gorillaz", "Demon Days", "Dirty Harry", R.drawable.gorillaz_demondays, userRecommandations),
                new Song("Gorillaz", "Demon Days", "Feel Good Inc.", R.drawable.gorillaz_demondays, userRecommandations),
                new Song("Gorillaz", "Demon Days", "El Manana", R.drawable.gorillaz_demondays, userRecommandations),
                new Song("Gorillaz", "Demon Days", "Every Planet We Reach Is Dead", R.drawable.gorillaz_demondays, userRecommandations),
                new Song("Gorillaz", "Demon Days", "November has come", R.drawable.gorillaz_demondays, userRecommandations),
                new Song("Gorillaz", "Demon Days", "White Light", R.drawable.gorillaz_demondays, userRecommandations),
                new Song("Gorillaz", "Demon Days", "Dare", R.drawable.gorillaz_demondays, userRecommandations),
                new Song("Gorillaz", "Demon Days", "Fire Coming Out Of The Monkey's Head", R.drawable.gorillaz_demondays, userRecommandations),
                new Song("Gorillaz", "Demon Days", "Don't Get Lost In Heaven", R.drawable.gorillaz_demondays, userRecommandations),
                new Song("Gorillaz", "Demon Days", "Demon Days", R.drawable.gorillaz_demondays, userRecommandations),
